...
<body>
	...
	<div class="cart-list-div">
			<table>
				...
				<c:forEach items="${clist}" var="cv" varStatus="status">
				<tr>
					<td class="check">
						<label class="check-container">
		                    <!-- 숨겨진 체크박스 -->
					...
					<td class="img">
						<img style="width: 150px; height: 150px;" src="${pageContext.request.contextPath}/cart//displayFile.aws?fileName=${cv.product_img1}">
					</td>
					...
					<td class="price">${cv.product_price}원</td>
